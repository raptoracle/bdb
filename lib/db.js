...
/** @typedef {import('./external')} ExternalDB */
 ...
 */
/**
 * @typedef {Object} ExternalDBClass
 * @property {(location: string, callback: function) => void} destroy
 * @property {(location: string, callback: function) => void} repair
 * @property {(location: string) => void} backup
 */
...
class DB {
  ...
  /** @type {LevelDBClass|MemDBClass|ExternalDBClass} */
  backend;
  ...
  /** @type {LevelDB|MemDB|ExternalDB} */
  binding;

  /**
   * Create a DB instance.
   * @constructor
   * @param {MemDBClass|LevelDBClass|ExternalDBClass} backend - Database backend.
